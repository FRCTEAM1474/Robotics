...
import org.usfirst.frc.team1474.Utilities.Constants;

public class CANSpeedControllerBuilder {						//automatically changes the frame rates of the talons for better performance
	...
	static {
		kSlaveConfiguration.STATUS_FRAME_GENERAL_1_MS = 100;			//Slaves lower than Master Talons
	...
	public static CKTalonSRX createFastMasterTalonSRX(int id, int pdpChannel) {			//Master Talons have increased rates
		Configuration masterConfig = new Configuration();
		masterConfig.CONTROL_FRAME_PERIOD_MS = 5;
		masterConfig.STATUS_FRAME_GENERAL_1_MS = 5;
		return createTalonSRX(id, pdpChannel, masterConfig);
