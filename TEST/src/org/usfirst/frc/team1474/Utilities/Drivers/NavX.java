 ...
 */
public class NavX {
    protected class Callback implements ITimestampedDataSubscriber {        //Need wrapper for gyro b/c need to invert the coordinate system; counterclockwise on navX is negative
        @Override
    ...
    public Rotation2d getYaw() {                                //reason Rotation2d used for getGyroAngle in DriveBaseSubsystem
