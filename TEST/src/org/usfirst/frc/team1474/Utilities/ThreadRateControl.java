...
import org.usfirst.frc.team1474.Utilities.TrajectoryFollowingMotion.MovingAverage;

public class ThreadRateControl {				//all this class does is it attempt to target target loop rate (based on delta T)
